...
function write_verson ($file)
{
    ...
    $_data .= "@define('WEPHI_VERSION', '" . SOFT_VERSION . "');\r\n";
    $_data .= "@define('WEPHI_RELEASE', '" . SOFT_RELEASE . "');\r\n";
    $fp = fopen ($file, 'w');
    fwrite ($fp, $_data);
    fclose ($fp);
}
...
function show_footer ($quit = true)
{
    ...
    echo <<<EOT
		<div class="footer">2011 <a href="http://Wephi.googlecode.com/" target="_blank">Wephi</a></div>
	</div>
</div>
</body>
</html>
